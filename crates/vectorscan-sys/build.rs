...
/// These bindings are pre-generated in the `src` folder for convenience. However, bindings can be freshly
/// generated by compiling this crate with the `generate-bindings` feature. For example:
/// ```text
/// cargo build --package vectorscan-sys --features=generate-bindings
/// ```
/// The location of the generated bindings will be logged as part of the build's output.
fn main() {
