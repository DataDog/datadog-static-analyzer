use crate::constants::CS_CONFIG_FILE_WITHOUT_EXTENSION;
...
#[cfg(test)]
mod tests {
    use crate::config_file::secrets::get_local_config;
    use crate::constants::CS_CONFIG_FILE_WITHOUT_EXTENSION;
    use std::fs;
...
";
    ...
    fn empty_config_file() {
        for content in ["", "\n  \t \r\n "] {
            ...
            let file_path = test_dir
                .path()
                .join(format!("{CS_CONFIG_FILE_WITHOUT_EXTENSION}.yaml"));
